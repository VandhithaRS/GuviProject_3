...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Momprincess@13', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Users\\VANDHITHA\\OneDrive\\Desktop\\backgroound.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By VANDHITHA RS",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *VANDHITHA RS*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\VANDHITHA\\OneDrive\\Desktop\\backgroound.jpg"), width=500)
